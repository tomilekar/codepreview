package com.tomilekar.AnimationC;
...
public class AnimationSpriteSorter_2 {
    ...
    public static  Animation<TextureRegion> getAnimation(Enum direction,  HashMap<Direction, Animation<TextureRegion>> animDir){
        return animDir.get(direction);
    }
    public static HashMap<Direction, Animation<TextureRegion>> getDirectionAnimationMap(Enum animation_,  HashMap<Animation_, HashMap<Direction, Animation<TextureRegion>>> complex){
        return complex.get(animation_);
    }
    public static HashMap<Animation_, HashMap<Direction, Animation<TextureRegion>>> textureRegionsMap(Direction[] directions, Animation_[] animations) {
        ...
        HashMap<Animation_, HashMap<Direction, Animation<TextureRegion>>> animationsMap = new HashMap<>();

        long startTime = System.nanoTime();
        Gdx.app.log(Helper, " start time : " + startTime / 1000000);
        for (Animation_ animation : animations) {
            HashMap<Direction, Animation<TextureRegion>> direction_animations = new HashMap<>();
    ...
    public static void main(String[] args) {
        ...
        final Animation_[] animations = Animation_.values();
        final Direction[] directions = Direction.values();
        int animationCounter = 0 ;
        for (final Animation_ animation : animations) {
